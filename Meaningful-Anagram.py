...
#Iterate over all permutations, use anagramica API to find if a genrated word is valid english word or not
for i in range (len (anagrams)) :
	response = urllib2.urlopen ('http://www.anagramica.com/lookup/' + anagrams[i])
